...
const NextJSIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center p-2 overflow-hidden">
      <img src="/nextjs.png" alt="NextJS" className="w-full h-full object-contain" />
    </div>
    <span className="text-xs font-bold text-white/70 uppercase tracking-wider">NextJS</span>
  </div>
);
